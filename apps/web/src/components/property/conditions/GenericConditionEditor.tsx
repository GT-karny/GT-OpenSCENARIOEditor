  ...
  return (
    <div className="space-y-2">
      ...
      <textarea
        ...
        onBlur={handleBlur}
        spellCheck={false}
        className="w-full min-h-[120px] rounded-md border border-input bg-muted px-3 py-2 text-xs font-mono resize-y focus:outline-none focus:ring-1 focus:ring-ring"
      />
