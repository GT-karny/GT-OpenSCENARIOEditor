...
export function HeaderToolbar() {
  ...
  return (
    <div
      role="banner"
      className="relative flex items-center h-[50px] px-6 gap-6 bg-[var(--color-glass-1)] backdrop-blur-[40px] saturate-[1.5] border-b border-[var(--color-glass-edge-mid)] header-glow z-10 enter select-none"
      style={inElectron ? { WebkitAppRegion: 'drag' } as React.CSSProperties : undefined}
    >
      {/* Interactive toolbar area — not draggable */}
      <div
        className="flex items-center gap-6 h-full"
        style={inElectron ? { WebkitAppRegion: 'no-drag' } as React.CSSProperties : undefined}
      >
        {/* Home button */}
