export const common = {
  ...
  labels: {
    ...
    savedAsOdr19: 'Saved as OpenDRIVE 1.9 — the document uses 1.9 features',
  ...
  odrProperty: {
    ...
    junction: {
      ...
      roadAtStart: 'Road At Start',
      roadAtEnd: 'Road At End',
      startLaneLink: 'Start Lane Link',
      endLaneLink: 'End Lane Link',
      linkedRoad: 'Linked Road',
      laneLinkS: 'S',
      laneLinkFrom: 'From',
      laneLinkTo: 'To',
      addCrossPath: 'Add cross path',
      deleteCrossPath: 'Delete cross path',
      addRoadSection: 'Add road section',
      deleteRoadSection: 'Delete road section',
      roadSectionRequiredHint: 'Crossing junctions require at least one road section.',
    },
    laneSection: {
    ...
    lane: {
      ...
      flagsTitle: 'Lane Flags',
      direction: 'Direction',
      advisory: 'Advisory',
      dynamicLaneType: 'Dynamic Lane Type',
      dynamicLaneDirection: 'Dynamic Lane Direction',
      roadWorks: 'Road Works (lane under construction)',
      addSpeed: 'Add speed',
      deleteSpeed: 'Delete speed entry',
      noSpeedEntries: 'No speed limits defined',
      accessTitle: 'Access Restrictions',
      noAccessEntries: 'No access restrictions defined',
      addAccessEntry: 'Add access entry',
      deleteAccessEntry: 'Delete access entry',
      sOffset: 'S Offset',
      restrictions: 'Restrictions',
      addRestriction: 'Add restriction',
      removeRestriction: 'Remove restriction {{type}}',
      legacyRestriction: 'Legacy: {{type}}',
      deprecatedBadge: 'Deprecated',
      deprecatedSuffix: '(deprecated)',
      deprecatedTooltip: "Deprecated — use {{replacement}} instead",
    },
    object: {
