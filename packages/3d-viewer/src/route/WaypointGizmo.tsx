 ...
 * When a waypoint is selected, renders a translucent ring that the user can drag
 * to move the waypoint along the road surface.
 *
 * Uses the same pointer-event + horizontal-plane raycasting pattern as RoadGizmo,
 * but does free road-surface projection (not axis-constrained).
 */
